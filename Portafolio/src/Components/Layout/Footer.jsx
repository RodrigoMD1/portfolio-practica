...
export const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content bg-gradient-to-r from-gray-700 via-gray-900 to-black">
            <aside className="items-center grid-flow-col">
                ...
                <p className='textFooter '>Copyright © 2023 - All right reserved</p>
            </aside>
